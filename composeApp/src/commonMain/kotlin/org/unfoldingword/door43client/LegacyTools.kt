...
import org.unfoldingword.door43client.API
...
internal object LegacyTools {
    ...
    fun injectGlobalCatalogs(library: org.unfoldingword.door43client.Library, host: String?) {
        val resolvedHost = if (!host.isNullOrBlank()) host else "https://td.unfoldingword.org"
        library.addCatalog(
            _root_ide_package_.org.unfoldingword.door43client.models.Catalog(
                "langnames",
                LANG_NAMES_URL,
                0
            )
        ...
        library.addCatalog(
            _root_ide_package_.org.unfoldingword.door43client.models.Catalog(
                ...
                "$resolvedHost/api/questionnaire/",
                0
            )
        )
        library.addCatalog(
            _root_ide_package_.org.unfoldingword.door43client.models.Catalog(
                "temp-langnames",
                "$resolvedHost/api/templanguages/",
                0
            )
        )
        ...
        library.addCatalog(
            _root_ide_package_.org.unfoldingword.door43client.models.Catalog(
                ...
                "$resolvedHost/api/templanguages/assignment/changed/",
                0
            )
        )
    }
    ...
    suspend fun downloadCatalogData(
        data: String,
        listener: org.unfoldingword.door43client.OnProgressListener?
     ...
     */
    @Throws(Exception::class)
    fun indexCatalogData(library: org.unfoldingword.door43client.Library, projects: List<DownloadedProject>) {
    ...
    private fun indexLanguagesForProject(
        library: org.unfoldingword.door43client.Library,
        pJson: JSONObject,
        languages: List<DownloadedLanguage>
    ) {
        for (language in languages) {
            val langJson = language.lJson.getJSONObject("language")
            val sl = _root_ide_package_.org.unfoldingword.door43client.models.SourceLanguage(
            ...
            library.addVersification(
                _root_ide_package_.org.unfoldingword.door43client.models.Versification(
                    "en-US",
                    "American English"
                ), languageId)
    ...
    private fun indexResourcesForLanguage(
        ...
        for (downloadedResource in resources) {
            ...
            val categories = mutableListOf<org.unfoldingword.door43client.models.Category>()
            if (pJson.has("meta")) {
                ...
                for (j in 0 until metaArray.length()) {
                    categories.add(
                        _root_ide_package_.org.unfoldingword.door43client.models.Category(
                            metaArray.getString(j),
                            projMetaArray.getString(j)
                        )
                    )
                }
            }
            ...
            val resource = Resource.fromJSON(rJson).apply {
                _legacyData[_root_ide_package_.org.unfoldingword.door43client.API.LEGACY_WORDS_ASSIGNMENTS_URL] = rJson.getString("tw_cat")
    ...
    suspend fun downloadAllChunks(
        ...
        listener: org.unfoldingword.door43client.OnProgressListener?
    ): Map<String, List<org.unfoldingword.door43client.models.ChunkMarker>> {
        val result = mutableMapOf<String, List<org.unfoldingword.door43client.models.ChunkMarker>>()
        markers.entries.forEachIndexed { index, (slug, url) ->
            ...
            result[slug] = (0 until chunks.length()).map { i ->
                ...
                _root_ide_package_.org.unfoldingword.door43client.models.ChunkMarker(
                    chunk.getString(
                        "chp"
                    ), chunk.getString("firstvs")
                )
            }
        }
        return result
    ...
    fun insertAllChunks(
        library: org.unfoldingword.door43client.Library,
        chunks: Map<String, List<org.unfoldingword.door43client.models.ChunkMarker>>,
