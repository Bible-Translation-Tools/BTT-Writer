...
import btt_writer.composeapp.generated.resources.search_source
import btt_writer.composeapp.generated.resources.search_translation
            ...
            TextButton(onClick = { showSubjectMenu = true }) {
                Text(
                    text = if (searchState.subject == SearchSubject.SOURCE) {
                        stringResource(Res.string.search_source)
                    } else {
                        stringResource(Res.string.search_translation)
                    },
                ...
                DropdownMenu(
                    ...
                    DropdownMenuItem(
                        text = { Text(stringResource(Res.string.search_source)) },
                        onClick = {
                    ...
                    DropdownMenuItem(
                        text = { Text(stringResource(Res.string.search_translation)) },
                        onClick = {
