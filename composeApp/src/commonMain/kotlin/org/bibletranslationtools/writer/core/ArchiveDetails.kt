...
import org.bibletranslationtools.writer.core.manifest.manifestJson
...
class ArchiveDetails private constructor(
    ...
    class Builder(
        ...
        private suspend fun processFile(archive: File, preferredLocale: String): ArchiveDetails? {
            if (archive.exists()) {
        ...
        private suspend fun parseV2Manifest(
            archive: File,
        ...
        suspend fun build(): ArchiveDetails? {
            return try {
                when {
