...
import btt_writer.shared.generated.resources.action_report_bug
...
import btt_writer.shared.generated.resources.export_to_usfm
import btt_writer.shared.generated.resources.image_large_download
...
import btt_writer.shared.generated.resources.project_uploaded
import btt_writer.shared.generated.resources.project_uploaded_to
import btt_writer.shared.generated.resources.tip_backup_to_door43
import btt_writer.shared.generated.resources.tip_backup_to_sd
import btt_writer.shared.generated.resources.tip_export_to_pdf
import btt_writer.shared.generated.resources.tip_export_to_usfm
...
import btt_writer.shared.generated.resources.use_internet_confirmation
import btt_writer.shared.generated.resources.view_online
...
fun ExportDialog(
    ...
    OverlayDialog(
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.title_upload_export),
                fontSize = 24.sp,
                modifier = Modifier.padding(bottom = 8.dp)
            )

            ExportOptionRow(
                title = stringResource(Res.string.backup_to_door43),
                tip = stringResource(Res.string.tip_backup_to_door43),
            ...
            ExportOptionRow(
                ...
                tip = stringResource(Res.string.tip_backup_to_sd),
                icon = Icons.Default.SdCard,
                onClick = {
            ...
            ExportOptionRow(
                title = stringResource(Res.string.backup_to_app),
    ...
    if (showInternetUsageDialog) {
        ConfirmDialog(
            title = stringResource(Res.string.use_internet_confirmation),
            message = stringResource(Res.string.image_large_download),
...
private fun UploadSuccessDialog(
    ...
    if (!showUploadDetailsDialog) {
        BaseDialog(
            onDismiss = onDismiss,
            title = stringResource(Res.string.upload_complete),
            message = stringResource(Res.string.project_uploaded_to, info.url)
        ) {
            Row(
                ...
                TextButton(
                    ...
                    Text(stringResource(Res.string.view_online))
                }
            }
        }
    } else {
        BaseDialog(
            ...
            title = stringResource(Res.string.project_uploaded),
