...
import btt_writer.shared.generated.resources.draft_translation_exists
...
fun TargetTranslationScreen(
    ...
    val draftExistsStr = stringResource(Res.string.draft_translation_exists)
    val draftPreview = stringResource(Res.string.preview)
